  ...
  return (
    <Element className="educationcontainer" id="education">
        ...
        <div className="edu_container">
            ...
            <h3>HSC Percentage:80%</h3>
            <p>I have completed my School in <span>Komarasamy Gounder Higher Secondary School</span></p>
            ...
            <h3>CGPA:7.88</h3>
            <h3>2023-2025</h3>
            <p>I am currently pursuing my master’s degree in computer application at <span>Rathinam Technical Campus</span></p>
            </div>
            </div>
        </div>
